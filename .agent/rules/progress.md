...
When checkpoints are done, including when told to commit, take all the accumulated progress in the current checkpoint `docs/current checkpoint.md`, and put it into a checkpoint architecture document.
