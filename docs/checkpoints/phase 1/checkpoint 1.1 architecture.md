# System Architecture - Current State (Checkpoint 1.2)

This document describes the architectural state of **Raw Output** as of Checkpoint 1.2 (Folder Picker Connectivity).
