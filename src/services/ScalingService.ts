...
export class ScalingService {
    ...
    public static calculateMultiplier(
        ...
        const masterFactor: number = SCALING_FACTORS[masterLevel] ?? SCALING_FACTORS.Normal;
        const specificFactor: number = SCALING_FACTORS[specificLevel] ?? SCALING_FACTORS.Normal;
