...
export class KovaaksCsvParsingService {
     ...
     */
    public parseKovaakCsv(csvContent: string, filename: string = ""): Partial<KovaaksChallengeRun> | null {
        ...
        return {
            scenarioName,
            score,
            completionDate: this._extractDateFromFilename(filename)
        };
    }
    ...
    private _extractDateFromFilename(filename: string): Date {
